  ...
  pillars: [
    {
      ...
      text: "Years of experience importing and selling premium Japanese vehicles with complete transparency and reliability.",
    },
    {
      title: "Bank loan facility",
      text: "Easy financing available through all major banks in Bangladesh, with a quick approval process and competitive rates.",
    },
    {
      title: "Cash purchase options",
      text: "Flexible terms for cash buyers, with special discounts on upfront payments and fully secure transactions.",
    },
    {
      title: "Customer satisfaction",
      text: "100% satisfaction guarantee with comprehensive after-sales support, warranty, and maintenance services.",
    },
  ],
  why: {
    kicker: "Why choose Mariam Automobile",
    title: "Built on trust, not pressure",
    sub: "Our reputation in Rajshahi is built on transparency, quality, and looking after customers long after the sale.",
  },
};
